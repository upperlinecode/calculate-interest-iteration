...
# Then call the function with two different initial amounts to ensure that it works properly.
...
# Then call the function with different amounts and different times.
...
# 6. Who has more money (Clara, Jerome, Z) in their account at age 45? At age 50? At age 65?
...
# 9. Compare the three payment strategies (Sage, Steve, Sid) to determine how much each graduate will end up paying to the loan company.
